...
namespace library1
{
    public partial class Staff : System.Web.UI.Page
    {
        ...
        protected void bindRegisterGrid()
        {
            ...
            try
            {
                SqlCommand cmd = new SqlCommand("Select * from Bookcollections AS BC Inner join Login As L On BC.UserId= L.id where roll='1' ", con);
        ...
        protected void ItemBind2()
        {
            try
            {
                ...
                string sError = string.Empty;
                DataTable dtbl = new DataTable();
                sQuery = "SELECT id as 'UserId',username FROM Login Where roll='1'";
                obj.CreateConnection("Connect");
                if (obj.FillDataTableByQueryString(ref dtbl, ref sError, sQuery) == true)
