<%@ Page Title="" Language="C#" MasterPageFile="~/New.Master" AutoEventWireup="true" CodeBehind="Ontime.aspx.cs" Inherits="library1.Ontime" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentBody" runat="server">
    <div class="container-fluid">
        <div >
        <div align="center" >
            <h4  style=" background-color:white; color:blue; padding-top:1%; padding-bottom:1%">
    ...
    <div  align="center">
<asp:Button ID="btngo" runat="server" CssClass="btn btn-primary" Text="Search On Time" 
